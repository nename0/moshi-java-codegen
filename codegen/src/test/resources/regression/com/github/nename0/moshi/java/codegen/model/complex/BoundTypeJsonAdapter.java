...
public final class BoundTypeJsonAdapter<T> extends JsonAdapter<BoundType<T>> {
  ...
  public BoundTypeJsonAdapter(Moshi moshi, Type[] types) {
    ...
    adapter_list = moshi.adapter(Types.newParameterizedType(List.class, Types.subtypeOf(Types
        .newParameterizedType(GenericInheritanceChain.class, types[0]))), Collections.emptySet(),
        "list");
    adapter_otherList = moshi.adapter(Types.newParameterizedType(List.class, Types.supertypeOf(
        String.class)), Collections.emptySet(), "otherList");
  }
